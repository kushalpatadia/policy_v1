...
class slider_management_control extends CI_Controller
{	
    function __construct()
    {
        ...
        check_admin_login();
		$this->load->model('slider_management_model');
		$this->load->model('imageupload_model');
		$this->obj = $this->slider_management_model;
    ...
    {	
        ...
        $data['sortfield']		= 'id';
        $data['sortby']			= 'desc';
        $searchsort_session = $this->session->userdata('slider_sortsearchpage_data');
		...
		$config['base_url'] = site_url($this->user_type.'/'."slider_management/");
		...
		if(!empty($searchtext))
		{
			$match=array('title'=>$searchtext,'image'=>$searchtext);
		...
		$slider_sortsearchpage_data = array(
        ...
        $this->session->set_userdata('slider_sortsearchpage_data', $slider_sortsearchpage_data);
    ...
    public function insert_data()
    {
		...
		{  
			$uploadFile = 'image';
			$bgImgPath = $this->config->item('slider_big_img_path');
			$smallImgPath = $this->config->item('slider_small_img_path');
			$thumb = "thumb";
			$hiddenImage = '';
