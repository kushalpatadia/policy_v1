...
class subcategory_management_control extends CI_Controller
{	
    function __construct()
    {
        ...
        check_admin_login();
		$this->load->model('subcategory_management_model');
		$this->load->model('imageupload_model');
		$this->obj = $this->subcategory_management_model;
    ...
    {	
        ...
        $data['sortfield']		= 'id';
        $data['sortby']			= 'desc';
        $searchsort_session = $this->session->userdata('subcategory_sortsearchpage_data');
		...
		$config['base_url'] = site_url($this->user_type.'/'."subcategory_management/");
		...
		if(!empty($searchtext))
		{
			$match=array('name'=>$searchtext,'category_name'=>$searchtext,'image'=>$searchtext);
			$data['datalist'] = $this->obj->select_records('subcategory','',$match,'','like','',$config['per_page'],$uri_segment,$sortfield,$sortby);
			$config['total_rows'] = count($this->obj->select_records('subcategory','',$match,'','like',''));
		
		}
		else
		{
			$data['datalist'] = $this->obj->select_records('subcategory','','','','','',$config['per_page'],$uri_segment,$sortfield,$sortby);	
			$config['total_rows']= count($this->obj->select_records('subcategory'));
		}
		$this->pagination->initialize($config);
		$data['pagination'] = $this->pagination->create_links();
		$data['msg'] = $this->message_session['msg'];

		$subcategory_sortsearchpage_data = array(
        ...
        $this->session->set_userdata('subcategory_sortsearchpage_data', $subcategory_sortsearchpage_data);
    ...
    public function insert_data()
    {
		...
		{  
			$uploadFile = 'image';
			$bgImgPath = $this->config->item('subcategory_big_img_path');
			$smallImgPath = $this->config->item('subcategory_small_img_path');
			$thumb = "thumb";
			$hiddenImage = '';
    ...
    public function edit_record()
    {
        ...
        $match = array('id'=>$id);
        $result = $this->obj->select_records('subcategory','',$match,'','=');
