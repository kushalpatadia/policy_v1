						...
						<div class="table-responsive">
							<div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
								...
								<div class="row dt-rt">
									...
									<div class="col-sm-6 hide"> <a class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add New
										<?=$head_title?>
									</a> </div>
								</div>
								<div id="common_div">
...
<!--<script type="text/javascript" src="<?=$this->config->item('js_path')?>script.js"></script> --><script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/contact_us/"+uri_segment,
			data: {
		...
		function delete_all(id)
		{
			...
			$.ajax({
				...
				success: function(data){
					$.ajax({
						type: "POST",
						url: "<?php echo base_url();?>admin/contact_us/"+data,
						data: {
