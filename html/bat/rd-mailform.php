...
$subject = "Contact: Contractor Mortgages Direct";

$message = "<html><head><title>Contractor Mortgages Direct</title></head><body><p>I want to contact you. My Email id is:".$_POST['email']."</p></body></html>";
