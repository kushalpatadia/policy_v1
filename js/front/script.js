...
(function () {
	...
	$(function () {
		...
		// 				result = result.length === 6 ? 'SUCCESS' : 'MF255';
		// 				output.text(msg[result]);
		...
		// 					}
		// 				}
		// 				if(document.getElementById('adisnal-email')){
		// 					var msill=document.getElementById('adisnal-email').value;
		// 					window.location.href="http://localhost/policy_v1/thankyou.html";
		// 				}
		// 				form.clearForm();
